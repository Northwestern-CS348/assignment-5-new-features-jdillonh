...
##### Your code to extractSubject here
    ...
    # other functions
    FOPCnames = core.resolveObjectFOPC(subject) #the names subjects take in the KB
    print("subject could refer to", FOPCnames)
...
##### Your code to resolveObjectFOPC here -- this will build some FOPC and Assert it
    ...
    core.findAndAttachPrepObjectsFOPC(root, subject, FOPCnames) # dil: this function does the assserting for us I guess
...
##### Your code to findAndAssertFeaturesFOPC here -- this takes the root and your names
    core.findAndAssertFeaturesFOPC(root, FOPCnames)

##### Your code to findAndAssertDefinitionsFOPC -- this takes the root and your names

    core.findAndAssertDefinitionsFOPC(root, FOPCnames)
